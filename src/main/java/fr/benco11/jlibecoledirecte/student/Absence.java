...
public class Absence {
	 ...
	 */
	public Absence(int id, int idEleve, String nomEleve, String typeElement, String date, String displayDate, String libelle, String motif, boolean justifie, String par, String commentaire, 
			String aFaire, String dateDeroulement) {
		this.id = id;
