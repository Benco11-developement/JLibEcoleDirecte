package fr.benco11.jlibecoledirecte.lib.factory;
...
public class DefaultAccountFactory implements AccountFactory {
    @Override
    public BasicAccount getAccount(AccountType accountType,
                                   List<EcoleDirecteModule> modules, PersonalDetails personalDetails,
