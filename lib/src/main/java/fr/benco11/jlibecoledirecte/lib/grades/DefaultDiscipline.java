...
public record DefaultDiscipline(int id, int groupId, int row, int headcount, String code,
                                String subCode,
                                String name, Mark average, List<String> comments, boolean isSubDiscipline,
                                boolean isGroupDiscipline,
                                boolean isOptional, List<Teacher> teachers,
                                List<Assignment> assignments) implements Discipline {
}
